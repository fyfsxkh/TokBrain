...
修改，必须增加有针对性的回归测试；如果风险状况发生变化，还必须同步更新 README
中的风险与安全边界、`SECURITY.md` 以及适用的第三方声明。
...
tests. A changed risk profile also requires synchronized updates to the risk
and security boundaries in the README, `SECURITY.md`, and any applicable
third-party notices.
