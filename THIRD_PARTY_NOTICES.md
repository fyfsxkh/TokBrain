...
TokBrain 使用下列第三方软件和资产。开源许可证只处理软件著作权，不授予访问第三方
平台的权限，也不授予处理、再分发或商业使用平台内容的许可。
...
TokBrain 和 F2 均不隶属于抖音、字节跳动、阿里云或任何内容创作者，也未获得其认可
或背书。
...
TokBrain uses the following third-party software and assets. Open-source
licenses apply to software copyright only; they do not grant access to
third-party platforms or permission to process, redistribute, or commercially
...
TokBrain and F2 are not affiliated with or endorsed by Douyin, ByteDance,
Alibaba Cloud, or any content creator.
